...
/datum/reagent/proc/insert_property(property, level)
	...
	var/list/combining_properties = list( PROPERTY_DEFIBRILLATING = list(PROPERTY_MUSCLESTIMULATING, PROPERTY_CARDIOPEUTIC),\
											...
											PROPERTY_ANGIOGENETIC = list(PROPERTY_HEMOSTATIC, PROPERTY_FOAMING),\
											PROPERTY_NIGHTVISION = list(PROPERTY_PHOTOSENSITIVE, PROPERTY_BIOLUMINESCENCE),\
											PROPERTY_WAVEABSORBING = list(PROPERTY_DISRUPTING, PROPERTY_ABSORBING)
											)
